...
@php
    ...
    $baseClass = implode(' ', [
        $case,
        'inline-flex text-center items-center justify-center gap-x-1 px-4 py-2 border rounded-md font-semibold',
...
@if ($disabled)
    <span {{ $attributes->merge(['class' => $linkClass]) }} aria-disabled="true">
        {{ $slot }}
    </span>
@else
